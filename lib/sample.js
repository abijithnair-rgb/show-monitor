...
export function sampleData() {
  ...
  const rcaRow = (o) => Object.assign({
    ...
    avg_cr: 58, avg_targ_cr: 60, cr_d4: 57, cr_d4_n: 18, cr_d2: 44, cr_d2_n: 15,
    corr_hdc_dau: 0.42, corr_sr_dau: 0.18, corr_hdc_sr: 0.55,
    comovement_pattern: 'aligned/normal', auto_rca: '',
  }, o);
  const rca = [
    // 2026-06-13 (latest)
    rcaRow({ level: 'TOTAL', segment: 'overall_httmk', hdc_supply: 110, hdc_count: 2, hdc_7davg: 6.1, hdc_rate: 3.7, hdc_rate_7davg: 12.9, hdc_verdict: 'HDC_DROP', hdc_attribution: 'HDC down mainly DISTRIBUTION (view misses — reach/recommendations)', miss_view_only: 32, miss_cr_only: 6, miss_both: 5,
      ...
      src_drop_driver: 'push 12000', usertype_drop_driver: 'new 9000', cohort_drop_driver: 'D1-D3 9000',
      top_surface_drops: 'home>for_you (-9000) | search>results (-2200)', peak_drop_hour: '20:00 (-3100 vs 7dAvg)',
      sr_pct: 87.8, sr_7davg: 80, sr_verdict: 'normal', cr_d4: 84, cr_d4_n: 40, cr_d2: 59.5, cr_d2_n: 30, comovement_pattern: 'CONTENT-LED DECLINE: HDC+SR+DAU all down — fresh content weak AND it is pulling DAU down' }),
