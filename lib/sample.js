...
export function sampleData() {
  ...
  const rcaRow = (o) => Object.assign({
    report_date: '2026-06-13', hdc_report_date: '2026-06-12', level: 'TOTAL', segment: 'overall_httmk',
    show_name: null, show_manager: null,
    // labels (settled day)
    supply: 20, l0: 5, l1: 4, l2: 2, l3: 2, l4: 4, l5: 3, l6: 0, l0_pct: 25, l4l5_pct: 35,
    hdc_count_7davg: 6, supply_7davg: 20, label_is_settled: true,
  ...
  const rca = [
    ...
    rcaRow({ level: 'TOTAL', segment: 'overall_httmk', supply: 110, l0: 2, l1: 8, l2: 6, l3: 14, l4: 45, l5: 35, l0_pct: 1.8, l4l5_pct: 72.7,
      hdc_count: 2, hdc_count_7davg: 6.1, hdc_7d: 28, supply_7d_seg: 760, hdc_contribution_pct_7d: 3.7, l4l5_pct_7d: 64,
    ...
    rcaRow({ level: 'LANGUAGE', segment: 'hi', supply: 70, l0: 14, l1: 12, l2: 8, l3: 10, l4: 16, l5: 10, l0_pct: 20, l4l5_pct: 37,
      hdc_count: 14, hdc_count_7davg: 20, hdc_7d: 110, supply_7d_seg: 480, hdc_contribution_pct_7d: 22.9, l4l5_pct_7d: 38,
    ...
    rcaRow({ level: 'BU', segment: 'Awareness', supply: 40, l0: 6, l1: 6, l2: 4, l3: 6, l4: 10, l5: 8, l0_pct: 15, l4l5_pct: 45,
      hdc_count: 6, hdc_count_7davg: 11, hdc_7d: 42, supply_7d_seg: 280, hdc_contribution_pct_7d: 15, l4l5_pct_7d: 46,
      hdc_verdict: 'HDC_DROP', hdc_attribution: 'HDC down mainly SUPPLY (fewer launches)', dau: 90000, dau_7davg: 92000, dau_7davg_pct: -2.2, dau_verdict: 'soft_drop', sr_pct: 52, sr_7davg: 59 }),
    rcaRow({ level: 'BU', segment: 'Income', supply: 15, l0: 5, l1: 2, l2: 3, l3: 2, l4: 2, l5: 1, l0_pct: 33, l4l5_pct: 20,
      hdc_count: 5, hdc_count_7davg: 4, hdc_7d: 30, supply_7d_seg: 100, hdc_contribution_pct_7d: 30, l4l5_pct_7d: 22,
      hdc_verdict: 'HDC_RISE', dau: 30000, dau_7davg: 28000, dau_7davg_pct: 7.1, dau_verdict: 'REAL_RISE', sr_pct: 64, sr_7davg: 58, comovement_pattern: 'FRESH HITS LIFTING DAU: HDC up + DAU up' }),
    rcaRow({ level: 'BU', segment: 'Skill', supply: 15, l0: 3, l1: 2, l2: 2, l3: 3, l4: 3, l5: 2, l0_pct: 20, l4l5_pct: 33,
      hdc_count: 3, hdc_count_7davg: 4, hdc_7d: 22, supply_7d_seg: 110, hdc_contribution_pct_7d: 20, l4l5_pct_7d: 34,
      hdc_verdict: 'normal', dau: 30000, dau_7davg: 29000, dau_7davg_pct: 3.4, dau_verdict: 'soft_rise', sr_pct: 60, sr_7davg: 60 }),
    ...
    // 2026-06-12 (previous settled day — second dropdown option)
    rcaRow({ report_date: '2026-06-12', hdc_report_date: '2026-06-11', level: 'TOTAL', segment: 'overall_httmk', supply: 108, l0: 30, l1: 10, l2: 8, l3: 15, l4: 25, l5: 20, l0_pct: 27.8, l4l5_pct: 41.7, hdc_count: 30, hdc_count_7davg: 30, hdc_contribution_pct_7d: 27, l4l5_pct_7d: 42, hdc_verdict: 'normal', dau: 205000, dau_7davg: 204000, dau_7davg_pct: 0.5, sr_pct: 61, sr_7davg: 60 }),
    rcaRow({ report_date: '2026-06-12', hdc_report_date: '2026-06-11', level: 'LANGUAGE', segment: 'hi', supply: 68, l0: 20, l1: 8, l2: 6, l3: 10, l4: 14, l5: 10, l0_pct: 29, l4l5_pct: 35, hdc_count: 20, hdc_count_7davg: 20, hdc_contribution_pct_7d: 29, l4l5_pct_7d: 35, hdc_verdict: 'normal', dau: 149000, dau_7davg: 148000, dau_7davg_pct: 0.7 }),
    // 2026-06-14 (latest — labels still settling)
    rcaRow({ report_date: '2026-06-14', hdc_report_date: '2026-06-13', level: 'TOTAL', segment: 'overall_httmk', label_is_settled: false, supply: 95, l0: 0, l1: 0, l2: 0, l3: 0, l4: 0, l5: 0, l0_pct: 0, l4l5_pct: 0, hdc_count: 0, hdc_rate: 0, hdc_count_7davg: 29, hdc_verdict: 'still_settling', hdc_contribution_pct_7d: null, dau: 208000, dau_7davg: 206000, dau_7davg_pct: 1.0, sr_pct: null, sr_verdict: 'still_tracking_72h', comovement_pattern: 'insufficient_baseline', auto_rca: 'HDC still settling (95 launched).' }),
    rcaRow({ report_date: '2026-06-14', hdc_report_date: '2026-06-13', level: 'LANGUAGE', segment: 'hi', label_is_settled: false, supply: 60, l0: 0, l1: 0, l2: 0, l3: 0, l4: 0, l5: 0, l0_pct: 0, l4l5_pct: 0, hdc_count: 0, hdc_rate: 0, hdc_count_7davg: 19, hdc_verdict: 'still_settling', hdc_contribution_pct_7d: null, dau: 150000, dau_7davg: 149000, dau_7davg_pct: 0.7 }),
    // SHOW rows (level='SHOW', Hindi, trailing 7d) — triage flags
    rcaRow({ level: 'SHOW', report_date: '2026-06-14', hdc_report_date: '2026-06-13', segment: 'Awareness', show_name: 'Vishnu Puran', show_manager: 'Nancy (2)', supply: 6, l0: 0, l1: 1, l2: 0, l3: 1, l4: 2, l5: 2, l0_pct: 0, l4l5_pct: 66.7, show_supply_7d: 6, show_freq: 7, show_supply_vs_freq_pct: 86, show_active_status: 'Active', bu_l0_pct: 15, bu_l4l5_pct: 45, poor_l0_flag: 1, high_l45_flag: 1, needs_supply_fix_flag: 0, hdc_verdict: 'POOR_L0', show_recommendation: 'HIT-RATE: L0 0% vs BU 15% — rework formats/hooks. TAIL: L4+L5 66.7% vs BU 45% — review topics/thumbnails/discovery.' }),
    rcaRow({ level: 'SHOW', report_date: '2026-06-14', hdc_report_date: '2026-06-13', segment: 'Skill', show_name: 'Editing Mastery', show_manager: 'Kartikey (2)', supply: 4, l0: 0, l1: 0, l2: 1, l3: 1, l4: 1, l5: 1, l0_pct: 0, l4l5_pct: 50, show_supply_7d: 4, show_freq: 7, show_supply_vs_freq_pct: 57, show_active_status: 'Inactive', bu_l0_pct: 20, bu_l4l5_pct: 33, poor_l0_flag: 1, high_l45_flag: 0, needs_supply_fix_flag: 1, hdc_verdict: 'POOR_L0', show_recommendation: 'SUPPLY: 4/7 wk (57% of target) — raise output. HIT-RATE: L0 0% vs BU 20% — rework formats/hooks.' }),
    rcaRow({ level: 'SHOW', report_date: '2026-06-14', hdc_report_date: '2026-06-13', segment: 'Income', show_name: 'Stock Market Daily', show_manager: 'Dhananjay (4)', supply: 5, l0: 2, l1: 1, l2: 1, l3: 0, l4: 1, l5: 0, l0_pct: 40, l4l5_pct: 20, show_supply_7d: 5, show_freq: 7, show_supply_vs_freq_pct: 71, show_active_status: 'Inactive', bu_l0_pct: 30, bu_l4l5_pct: 22, poor_l0_flag: 0, high_l45_flag: 0, needs_supply_fix_flag: 1, hdc_verdict: 'ok', show_recommendation: 'SUPPLY: 5/7 wk (71% of target) — raise output.' }),
  ];
