    ...
    for (let i = 0; i < 10; i++) {
      ...
      out.push(
        Object.assign({}, base, {
          ...
          // CMS snapshot fields (content_metrics_run_log_v2). Newest 2 episodes
          // are still provisional (H1/H12); older ones are frozen at H123.
          ...
          snapshot_tag: i === 0 ? 'H1' : i === 1 ? 'H12' : 'H123',
        })
      );
    }
    return out;
