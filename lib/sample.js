...
export function sampleData() {
  ...
  const rca = [
    // 2026-06-13 (latest)
    rcaRow({ level: 'TOTAL', segment: 'overall_httmk', hdc_supply: 110, hdc_count: 2, hdc_7davg: 6.1, hdc_rate: 3.7, hdc_rate_7davg: 12.9, hdc_verdict: 'HDC_DROP', hdc_attribution: 'HDC down mainly DISTRIBUTION (view misses — reach/recommendations)', miss_view_only: 32, miss_cr_only: 6, miss_both: 5, dau: 210000, dau_7davg: 205000, dau_7davg_pct: 2.4, dau_verdict: 'soft_rise', sr_pct: 87.8, sr_7davg: 80, sr_verdict: 'normal', cr_d4: 84, cr_d4_n: 40, cr_d2: 59.5, cr_d2_n: 30, comovement_pattern: 'LEADING RISK: HDC down but DAU still holding on catalog — expect DAU softness if it persists' }),
