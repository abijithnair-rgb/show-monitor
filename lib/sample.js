...
export function sampleData() {
  ...
  // Language-level success rate (settled series, active shows) — one row/language.
  const langsr = [
    { language: 'hi', series: 142, successful: 96, failed: 46 },
    { language: 'ta', series: 58, successful: 33, failed: 25 },
    { language: 'te', series: 64, successful: 41, failed: 23 },
    { language: 'ml', series: 37, successful: 19, failed: 18 },
    { language: 'kn', series: 29, successful: 14, failed: 15 },
  ];
