...
// Distinct categories in the model, with a show count, sorted by label. When
// `lang` is given, only categories present in that language are counted.
export function categoryValues(model, lang) {
