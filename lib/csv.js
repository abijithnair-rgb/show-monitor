...
import { EVAL_REQUIRED, FAT_REQUIRED, FAT_EITHER, HDC_REQUIRED, TS_REQUIRED, META_REQUIRED, AUDIENCE_REQUIRED } from './constants';
...
export function parseCombined(file, cb) {
  Papa.parse(file, {
    ...
    complete: (res) => {
      ...
      const buckets = { eval: [], fatigue: [], hdc: [], timespent: [], meta: [], audience: [] };
      let badJson = 0;
      for (const r of rows) {
