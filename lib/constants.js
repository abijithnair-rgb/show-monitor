...
// Per-show success rate (one row per show): settled-series successful/failed,
// with language for roll-ups. Rolled up to language / BU / POC client-side.
export const LANGSR_REQUIRED = ['show_id', 'successful', 'failed'];
...
export const TABS = [
  ...
  { id: 'guide', label: 'Glossary', tip: 'Metric definitions & how the frameworks combine', gated: false },
];
