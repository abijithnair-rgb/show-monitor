...
// Retention CSV (one row per show): NURR/CURR/RURR/SURR next-day return rates + bases.
export const RETENTION_REQUIRED = ['show_id', 'nurr_pct', 'curr_pct', 'rurr_pct', 'surr_pct'];
