...
// episode H123 completion rate — prefer the CMS snapshot's completion_rate
// (content_metrics_run_log_v2, source of truth), fall back to raw-watching.
const epComp = (e) => num(e.completion_rate) ?? num(e.h123_completion_rate_pct);
