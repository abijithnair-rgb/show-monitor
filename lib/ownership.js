...
export function metricSnapshot(s, hdcIdx, fatIdx, fatRows) {
  ...
  return {
    ...
    labels,
    // dominant failure mode recomputed from the episodes (matches the Last-10
    // table & the fatigue lens), so fix-experiment verdicts agree with the table.
    dominant: eps ? dominantFromEps(eps) : null,
