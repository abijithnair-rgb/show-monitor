...
// Permanently remove a concluded experiment from a show's history.
export const deleteHistoryAction = (id, show_id) => post({ op: 'delete_history', id, show_id });
// Override a show's manager (self-assign). Empty/null name clears the override.
export const setManagerAction = (show_id, manager) => post({ op: 'set_manager', show_id, manager });
